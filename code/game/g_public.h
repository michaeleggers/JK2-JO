...
typedef struct {
	...
	int			(*ReadFromSaveGame)(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr); //**ppvAddressPtr = NULL
	int			(*ReadFromSaveGameOptional)(unsigned long chid, void *pvAddress, int iLength, void **ppvAddressPtr); // **ppvAddressPtr = NULL
	...
	void	(*trace)( trace_t *results, const vec3_t start, const vec3_t mins, const vec3_t maxs, const vec3_t end, 
			const int passEntityNum, const int contentmask , const EG2_Collision eG2TraceType, const int useLod); //const EG2_Collision eG2TraceType = (EG2_Collision)0, const int useLod = 0
...
int			(*G2API_InitGhoul2Model)(CGhoul2Info_v &ghoul2, const char *fileName, int modelIndex, qhandle_t customSkin, //  qhandle_t customSkin = NULL
								  qhandle_t customShader, int modelFlags, int lodBias); // qhandle_t customShader = NULL, int modelFlags = 0, int lodBias = 0
...
qboolean	(*G2API_SetBoneAnim)(CGhoul2Info *ghlInfo, const char *boneName, const int startFrame, const int endFrame,
							  const int flags, const float animSpeed, const int currentTime, const float setFrame, const int blendTime); // const float setFrame = -1, const int blendTime = -1
...
qboolean	(*G2API_SetBoneAngles)(CGhoul2Info *ghlInfo, const char *boneName, const vec3_t angles,
								   ...
								   qhandle_t *modelList, int blendTime, int blendStart); // int blendTime = 0, int blendStart = 0
qboolean	(*G2API_SetBoneAnglesMatrix)(CGhoul2Info *ghlInfo, const char *boneName, const mdxaBone_t &matrix, const int flags,
									  qhandle_t *modelList, int blendTime, int currentTime); // int blendTime = 0, int currentTime = 0
...
void		(*G2API_CopyGhoul2Instance)(CGhoul2Info_v &ghoul2From, CGhoul2Info_v &ghoul2To, int modelIndex); // int modelIndex = -1
...
qboolean	(*G2API_SetBoneAnimIndex)(CGhoul2Info *ghlInfo, const int index, const int startFrame, const int endFrame, const int flags, const float animSpeed, const int currentTime, const float setFrame, const int blendTime); // const float setFrame = -1, const int blendTime = -1
